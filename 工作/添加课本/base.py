...
def insert_sql(index, summary_key, subject_name, subject_code, grade, book_name, book_version,
    ...
    for index, item in enumerate(unit[:-1]):
        ...
        for chapter in chapters:
            print(
                sql_chapter.format(chapter_id=chapter_id, chapter_name=pymysql.escape_string(chapter.lstrip().strip()),
...
def main():
    ...
    insert_sql(2, "kx", "科学", "040", "3", "科学教科版三下", "教育科学出版社", "037100", "0404/科学教科版三下.txt")
