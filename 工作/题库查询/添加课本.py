...
if __name__ == '__main__':
    ...
    edition_id = "155217"
    sql_book = "INSERT INTO `topic_standard_test`.`t_res_book` (`book_id`, `book_name`, `book_version`, `edition_id`, `subject_code`, `subject_name`, `cover`, `create_time`, `finish`) " \
               "VALUES ('{book_id}', 'book_name', '{book_version}', '{edition_id}', '010', '{subject_name}', " \
               "'http://dfs.res.jzexueyun.com/bookcover/200x200_003d248cab9bbbcbbad8eb2f3d30879c.jpg', '2017-11-15 10:41:31', '1');"
    sql_grade_book = "INSERT INTO `topic_standard_test`.`t_res_graduate_book` (`book_id`, `grade`, `semester`, `create_time`) " \
                     "VALUES ('{book_id}', '{grade}', '1', '2017-11-15 10:41:31');"
    sql_unit = "INSERT INTO `topic_standard_test`.`t_res_units` (`unit_id`, `unit_name`, `book_id`, `create_time`) " \
               "VALUES ('{unitId}', '{unitName}', '{bookId}', '2017-11-16 12:54:21')"
    sql_chapter = "INSERT INTO `topic_standard_test`.`t_res_chapter` (`chapter_id`, `chapter_name`, `unit_id`, `book_id`, `summary_key`, `create_time`, `finish`) " \
